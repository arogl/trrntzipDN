...
namespace TrrntzipDN.SupportedFiles.SevenZip.Compress.PPmd
{
    public class PpmdStream : Stream
    {
        ...
        private TrrntzipDN.SupportedFiles.SevenZip.Compress.RangeCoder.Decoder decoder;
        ...
        public PpmdStream(PpmdProperties properties, Stream stream, bool compress)
        {
            ...
            if (properties.Version == PpmdVersion.H7z)
            {
                ...
                decoder = new TrrntzipDN.SupportedFiles.SevenZip.Compress.RangeCoder.Decoder();
                decoder.Init(stream);
            }
        }
