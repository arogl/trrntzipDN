...
namespace TrrntzipDN.SupportedFiles.SevenZip.Compress.PPmd.H
{
    internal class ModelPPM
    {
        ...
        public int decodeChar(TrrntzipDN.SupportedFiles.SevenZip.Compress.RangeCoder.Decoder decoder)
        {
            if (minContext.NumStats != 1)
            {
